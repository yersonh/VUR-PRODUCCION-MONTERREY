...
use App\Http\Controllers\Api\Admin\ReportesAdminController;
...
Route::prefix('v1')->group(function () {
    ...
    // CDR notificando un cambio de estado de un trámite que ya le enviamos
    // (ver EnviarSolicitudResidenciaACdr). Va bajo el mismo prefijo que el
    // intake, no bajo /radicados/{id}/estado — ese ya existe para el uso
    // interno con Sanctum + id numérico, y {radicado_vur} es un string
    // "AAAA-NNNNNN" distinto, así que compartir la ruta chocaría.
    Route::patch('solicitudes-carta-residencia/{radicadoVur}/estado', [SolicitudCartaResidenciaController::class, 'actualizarEstado'])
        ->middleware('cdr.token')
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // Auth — accesibles incluso con cambio de contraseña pendiente
        Route::get('auth/me',                [AuthController::class, 'me']);
        Route::post('auth/logout',           [AuthController::class, 'logout']);
        Route::post('auth/cambiar-password', [AuthController::class, 'cambiarPassword']);

        // ── El resto de la API exige haber completado el cambio de la
        // contraseña asignada (ver EnsureNoDebePasswordChange) ─────
        Route::middleware('password.ok')->group(function () {

            Route::get('auth/foto',    [AuthController::class, 'foto']);
            ...
            Route::middleware('admin')->prefix('admin')->group(function () {
                ...
                Route::patch('usuarios/{user}/reset-password',  [UserAdminController::class, 'resetPassword']);
                ...
                // Ciudadanos (Core) — soporta editar, el Core ya expone
                // PUT /ciudadanos/{id}
                ...
                // Empresas (Core) — solo crear + listar, el Core todavía
                // no expone PUT /empresas/{id}
