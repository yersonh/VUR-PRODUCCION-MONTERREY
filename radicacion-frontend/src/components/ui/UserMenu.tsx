...
const ROLE_COLORS: Record<string, string> = {
  ...
  JEFE_DEPENDENCIA: 'text-emerald-300 bg-emerald-400/15 border-emerald-400/30',
    ...
    <>
      <div ref={ref} className="relative">
        ...
        <button
          ...
          `}
        >
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#2B5BA8] to-[#1B3A6E] border-2 border-[#C8A800]/70 flex items-center justify-center text-white text-[11px] font-bold shrink-0 shadow-md">
            {initials}
          </div>
            ...
            >
              ...
              <div className="px-5 pt-5 pb-4">
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#2B5BA8] to-[#0f2348] border-2 border-[#C8A800]/60 flex items-center justify-center text-white text-lg font-bold shadow-lg shrink-0">
                    {initials}
                  </div>
